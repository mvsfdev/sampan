define(function(require, exports, module) {
    ...
    var Module = require("modules/collections/polygons");
    var Polygon = require("modules/models/polygon");
    
    // Test that the module exists.
    describe("collections/polygons", function() {
        ...
        describe("creation",function() {
            it("should has default values",function() {
                ...
                expect(this.modules).to.have.property('model',Polygon);
                expect(this.modules.model).to.be.equal(Polygon);
            });
        ...
        describe("modification", function() {
            it('has a module', function() {
                this.modules.add([{position: {x: 30,y: 90}, id: "polygon_1"}]);
            ...
            it('can create second module', function() {
                ...
                modules.add([{position: {x: 90,y: 20}, id: "polygon_2"}]);
                expect(modules).to.have.length(1);
